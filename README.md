...
| `npm run db:test:remote` | roda os mesmos testes no projeto Supabase vinculado, sem Docker, sempre com rollback |
| `npm run db:test` | testes pgTAP via `supabase test db` (exige Docker) |
