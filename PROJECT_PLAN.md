...
> **Estado atual (2026-09-23):** fundação, onboarding/equipe, solicitações, CRM Kanban e Inbox entregues — fases 1, 2, 3, 4, 7, 9, quase toda a 8 e parte de 5 e 6 (ver §9). Produção: https://saas-turismo-ivory.vercel.app
...
| 16 | ✅ concluída | 2026-09-23 | migration 0014: cotação → opções → itens (aéreo, hospedagem, transfer, passeio, seguro, outro) com detalhes por tipo validados; **preços calculados pelo banco** (preço = qtd × (custo + markup + taxas); total = subtotal + taxa de serviço − desconto; margem; comissão; totais forjados ignorados e colunas calculadas bloqueadas para usuários); cotação pronta fica travada; opções duplicáveis; margem desejada → markup; negócio avança para “Cotação em andamento”/“Cotação pronta” e a tarefa “Preparar cotação” é concluída automaticamente. Consultores veem margem (decisão). 117/117 testes no Supabase real |
| 11–15, 17–30 | ⏳ não iniciada | — | IA (11–14) aguarda escolha do modelo e chave; WhatsApp (15) aguarda credenciais da Meta; propostas (17) é a próxima |
